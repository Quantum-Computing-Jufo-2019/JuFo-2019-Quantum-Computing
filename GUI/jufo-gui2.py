...
# Form implementation generated from reading ui file 'Jufo2.ui'
#
...
combobox_qubo_files = ["./Hamiltonians/qubomatrix_4_diagBesetzt.txt","./Hamiltonians/qubomatrix_5_diagBesetzt.txt","./Hamiltonians/qubomatrix_6_diagBesetzt.txt","./Hamiltonians/qubomatrix_7_diagBesetzt.txt","./Hamiltonians/qubomatrix_7_diagFrei.txt","./Hamiltonians/qubomatrix_8_diagBesetzt.txt"]
combobox_n =          [4,5,6,7,7,8,3]
combobox_chess_n =    [4,5,6,7,8,8,3]
combobox_diag_frei =  [False,False,False,False,True,False]
combobox_optimal =    [-8,-10,-12,-14,-14,-16,-14]
reads_per_request = 1000
max_reads = 20000

def qubo(matrix_text_file,num_reads_times_hundred,annealing_time,n,chess_n,best_result,diag_frei):
...
def start():
	print(JufoQubo.frameGeometry().height())
	...
	qubo(combobox_qubo_files[hamiltonian_select_index],(ui.durchlaufe_slider.value()/reads_per_request),ui.annealing_slider.value(),combobox_n[hamiltonian_select_index],combobox_chess_n[hamiltonian_select_index],combobox_optimal[hamiltonian_select_index],combobox_diag_frei[hamiltonian_select_index])
...
class Ui_JufoQubo(object):
    def setupUi(self, JufoQubo):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 695, 589))
        ...
        self.durchlaufe_slider.setMaximum(max_reads)
    ...
    def retranslateUi(self, JufoQubo):
        ...
        self.durchlaufe_max.setText(_translate("JufoQubo", str(max_reads), None))
