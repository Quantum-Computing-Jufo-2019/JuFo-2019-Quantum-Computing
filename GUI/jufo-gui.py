...
combobox_n =          [4,5,6,7,8,3]
combobox_optimal =    [-8,-10,-12,-14,-16,-14]
reads_per_request = 1000

def qubo(matrix_text_file,num_reads_times_hundred,annealing_time,n,best_result):
...
def start():
	...
	ui.results_table.setRowCount(combobox_n[hamiltonian_select_index])
	ui.results_table.setColumnCount(combobox_n[hamiltonian_select_index])
	qubo(combobox_qubo_files[hamiltonian_select_index],(ui.durchlaufe_slider.value()/reads_per_request),ui.annealing_slider.value(),combobox_n[hamiltonian_select_index],combobox_optimal[hamiltonian_select_index])
...
class Ui_JufoQubo(object):
    def setupUi(self, JufoQubo):
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 695, 583))
        ...
        self.results_table.setItem(0,1, QTableWidgetItem("Item (1,2)"))
